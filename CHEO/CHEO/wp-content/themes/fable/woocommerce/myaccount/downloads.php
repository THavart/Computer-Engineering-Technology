...
<?php if ( $has_downloads ) : ?>
	...
	<table class="woocommerce-MyAccount-downloads shop_table theme-table-responsive-on">
		<thead>
			<tr>
...
<?php
		...
		'
			...
			[pb_notice_second_line]'.__('No downloads available yet.','woocommerce').'[/pb_notice_second_line]
			[/pb_notice]		
		';
