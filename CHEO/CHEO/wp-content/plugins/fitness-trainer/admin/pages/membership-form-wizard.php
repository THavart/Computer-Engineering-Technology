	...
	<div class="welcome-panel container-fluid">
		...
		<div class="panel panel-info">
			<div class="panel-body">		
					...
					<ul class="list-group col-md-6">
							<li class="list-group-item">Short Code : <code>[ep_fitness_form_wizard]  </code></li>
							...
							<li class="list-group-item"> Signup Page : 
								<?php 
										$form_wizard=get_option('_ep_fitness_registration');
										  ?>
		...
		<div class="form-group col-md-12 row">			
			...
			<?php
					...
					if(get_option('ep_fitness_signup-template')){
						$opt_style=	get_option('ep_fitness_signup-template');
			...
			<table class="table table-striped">
				<tr>
					...
					<td width="85%">
						<?php include( wp_ep_fitness_template.'signup/wizard-style-1.php');?>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						<?php  include( wp_ep_fitness_template.'signup/wizard-style-2.php');?>
					</td>	
				</tr>	
...
function update_wizard_template(){
		...
		var search_params = {
			"action": 			"ep_fitness_update_signup_template",
