<?php
wp_enqueue_style('wp-ep_fitness-style-13', wp_ep_fitness_URLPATH . 'admin/files/css/form-wizard-style-1.css');
global $wpdb;
?>
<style>
.bs-callout {
		  ...
		  <div class="panel with-nav-tabs panel-info">
					<div class="panel-heading">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#page" data-toggle="tab"><?php _e('Page','epfitness'); ?></a></li>
								
								<li ><a href="#color-setting" data-toggle="tab"><?php _e('Color','epfitness'); ?> </a></li>
								
								<li><a href="#payment" data-toggle="tab"><?php _e('Payment Page','epfitness'); ?></a></li>
								<li><a href="#email" data-toggle="tab"><?php _e('Email','epfitness'); ?> </a></li>								
								<li><a href="#mailchimp" data-toggle="tab"><?php _e('MailChimp','epfitness'); ?> </a></li>
								<li ><a href="#user_reg" data-toggle="tab"><?php _e('Page Redirect','epfitness'); ?></a></li>								
							
								<!--
								<li ><a href="#protected_page" data-toggle="tab"><?php _e('Protected Page','epfitness'); ?></a></li>
								-->
					...
					<div class="panel-body">
						<div class="tab-content">			
								<div class="tab-pane fade " id="color-setting">								
									<?php
										...
										$thank_you=get_option('_ep_fitness_thank_you_page'); 	
														...
														$args = array(
															...
															<div class="form-group">
																...
																<div class="form-group">
																	<label  class="col-md-2   control-label"><?php _e('Cron Job URL','epfitness');  ?> </label>
									...
									<form class="form-horizontal" role="form"  name='email_settings' id='email_settings'>	
										...
										<div class="form-group">
												...
												<div class="col-md-4 ">
													...
													?>
													<input type="text" class="form-control" id="ep_fitness_admin_email" name="ep_fitness_admin_email" value="<?php echo $admin_email_setting; ?>" placeholder="">
										...
										<div class="form-group">
												...
												<div class="col-md-4 ">
														...
														<input type="text" class="form-control" id="ep_fitness_signup_email_subject" name="ep_fitness_signup_email_subject" value="<?php echo $ep_fitness_signup_email_subject; ?>" placeholder="Enter signup email subject">
										...
										<div class="form-group">
												...
												<div class="col-md-4 ">
														...
														<input type="text" class="form-control" id="forget_email_subject" name="forget_email_subject" value="<?php echo $ep_fitness_forget_email_subject; ?>" placeholder="Enter forget email subject">
										...
										<div class="form-group">
												<h3  class="col-md-12 col-xs-12 col-sm-12  page-header">Approval Email </h3>
										...
										<div class="form-group">
												...
												<div class="col-md-4 ">
														...
														?>
														<input type="text" class="form-control" id="ep_fitness_order_email_subject" name="ep_fitness_order_email_subject" value="<?php echo $ep_fitness_order_email_subject; ?>" placeholder="Enter order email subject">
										...
										<div class="form-group">
												...
												<div class="col-md-4 ">
														...
														?>
														<input type="text" class="form-control" id="ep_fitness_order_admin_email_subject" name="ep_fitness_order_admin_email_subject" value="<?php echo $ep_fitness_order_admin_email_subject; ?>" placeholder="Enter order email subject">
										...
										?>
										<div class="form-group">
												<h3  class="col-md-12 col-xs-12 col-sm-12  page-header">Denial Email</h3>
										</div>
										<div class="form-group">
										<?php
											//include (wp_ep_fitness_DIR .'/admin/pages/denial_email.php');
										?>
										</div>
										<div class="form-group">
												<label  class="col-md-2   control-label"> Denial Email Subject : </label>
												<div class="col-md-4 ">
														<?php $ep_fitness_denial_email_subject = get_option( 'ep_fitness_denial_email_subject'); ?>
										...
										<div class="form-group">
												...
												<div class="col-md-10 ">
													...
													?>
													<textarea id="<?php echo $editor_id ;?>" name="<?php echo $editor_id ;?>" rows="20" class="col-md-12 "><?php echo $content_denial; ?></textarea>
												</div>
										</div>
										<div class="form-group">
												<h3  class="col-md-12 col-xs-12 col-sm-12  page-header">Active</h3>
										</div>
										<div class="form-group">
												<label  class="col-md-2   control-label"> Active Subject: </label>
												<div class="col-md-4 ">
														<?php $ep_fitness_denial_active_email_subject = get_option( 'ep_fitness_denial_active_email_subject'); ?>
													<input type="text" class="form-control" id="ep_fitness_denial_active_email_subject" name="ep_fitness_denial_active_email_subject" value="<?php echo $ep_fitness_denial_active_email_subject; ?>" placeholder="Enter active denial email subject">												
												</div>
										</div>
										<div class="form-group">
												<label  class="col-md-2   control-label">Denial Activer Email Tempalte : </label>
												<div class="col-md-10 ">
													<?php
														$settings_a = array(															
															'textarea_rows' =>20,															 
															);
														$content_denial = get_option( 'ep_fitness_active_denial_email');
														$editor_id = 'denial_activer_email_template';
														//wp_editor( $content_reminder, $editor_id,$settings_a );										
													?>
													<textarea id="<?php echo $editor_id ;?>" name="<?php echo $editor_id ;?>" rows="20" class="col-md-12 "><?php echo $content_denial; ?></textarea>
												</div>
										...
										<form class="form-horizontal" role="form"  name='mailchimp_settings' id='mailchimp_settings'>
												<div class="form-group row">
													...
													<div class="col-md-4 col-xs-6 col-sm-6">
														...
														?>
														<input type="text" class="form-control" id="ep_fitness_mailchimp_api_key" name="ep_fitness_mailchimp_api_key" value="<?php echo $iv_mailchimp_api_key; ?>" placeholder="">
												...
												<div class="form-group row">
													...
													<div class="col-md-4 col-xs-6 col-sm-6 ">
														...
														?>
														<select class="form-control" id="ep_fitness_mailchimp_confirmation" name="ep_fitness_mailchimp_confirmation">
															<option value="no" <?php echo ($ep_fitness_mailchimp_confirmation == 'no' ? 'selected' : '') ?>>Yes</option>
															<option value="yes" <?php echo ($ep_fitness_mailchimp_confirmation == 'yes' ? 'selected' : '') ?>>No</option>
														</select>
									...
									<div class="col-md-4 col-xs-6 col-sm-6">
										<?php 
											if( ! class_exists('MCAPI' ) ) {
													require_once(wp_ep_fitness_DIR . '/inc/MCAPI.class.php');
												}
												$iv_mailchimp_api_key='';
												if( get_option( 'ep_fitness_mailchimp_api_key' )==FALSE ) {
														$iv_mailchimp_api_key = get_option('ep_fitness_mailchimp_api_key');						 
...
function iv_update_reminder_email_settings(){
				...
				var search_params={
					"action"  : 	"ep_fitness_update_reminder_email_setting",	
...
var search_params={
		"action"  : 	"ep_fitness_update_post_setting",	
...
var search_params={
		"action"  : 	"ep_fitness_update_protected_setting",	
