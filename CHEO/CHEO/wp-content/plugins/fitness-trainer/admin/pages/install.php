...
update_option('ep_fitness_admin_email_green', $admin_email_template ); 
update_option('ep_fitness_client_email_green', $client_email_template );

	
								$admin_email_template2='<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#ececec url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg-tile-grey.jpg) repeat-x left top">
									<tbody><tr>
									  <td align="center" valign="top">
										  ...
										  <td align="center" valign="top">
											...
											<tbody><tr>
											  <td align="right" valign="top">
												<img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/shim.gif" width="1" height="30">
											  </td>
											</tr>
											</tbody></table>
										  </td>
										  ...
										  <td align="center" style="padding-top:30px">
											...
											<tbody><tr>
											  <td align="left" valign="top" style="padding:25px 13px 40px">
												<img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/top-image-2.jpg" style="display:block;border:none" width="660" height="220" alt="'.get_bloginfo().'">
											  </td>
											</tr>
											</tbody></table>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
									  ...
									  <tr>
										...
										<tbody><tr>
										  <td colspan="2" align="left" valign="middle" style="border-bottom-width:6px;border-bottom-color:#b3b3b3;border-bottom-style:solid">
											<img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/shim.gif" width="1" height="20">
										  </td>
										</tr>
										<tr>
										...
										<tr>
										  <td colspan="2" style="padding:10px 0 30px">
											<img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/divider-grey.jpg" width="689" height="1">
										  </td>
										</tr>
										</tbody></table>
									  </td>
								...
								$client_email_template2	='<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#ececec url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg-tile-grey.jpg) repeat-x left top">
									<tbody><tr>
									  <td align="center" valign="top">
										<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
										<tbody><tr>
...
update_option('ep_fitness_admin_email_black_white', $admin_email_template2 ); 
update_option('ep_fitness_client_email_black_white', $client_email_template2 );
...
$admin_email_template3='<div>
												...
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>
														<td valign="top" align="center" id="top" style="padding: 0px;margin: 0px;background-image: url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_body.gif);background-repeat: repeat-y no-repeat;background-position: top center;background-color: #3d4852;" bgcolor="#3d4852" background="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_body.gif">
															...
															<table style="font-family: Verdana, Arial, sans-serif; color: #8d9ca4;font-size: 10px;margin: 0; text-align:center;" cellpadding="0" cellspacing="0" align="center" width="600">
																<tr>
																	<td valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" width="1" height="8" alt="" /></td>
																</tr>
																
																<tr>
																	<td style="background: url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_top.png) no-repeat;"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" width="1" height="12" alt="" /></td>
																</tr>
															</table>
															<table cellpadding="0" cellspacing="0" align="center" width="600" style="background: url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_email_singlecol.png) repeat-y;">
																<tr>
																	<td rowspan="4" valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" width="15" height="1" alt="" /></td>
																	<td rowspan="4" valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/header_strip.gif" alt="" width="20" height="249" /></td>
																	<td rowspan="3" valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/header_l.gif" alt="" width="405" height="184" /></td>
																	<td bgcolor="#fbfdfd" colspan="2" width="100" height="26"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" width="100" height="26" alt="" /></td>
																	<td rowspan="4" valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/header_r.gif" alt="" width="45" height="249" /></td>
																	<td rowspan="4" valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" width="15" height="1" alt="" /></td>
																</tr>
																<tr>
																	<td valign="top"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/header_mbsbg.gif" width="16" height="79" alt="" /></td>
																	<td valign="top" width="84" align="left" style="background-image: url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/header_mbg.gif);background-repeat: repeat-y no-repeat;background-position: top center;background-color: #f2f8fa;" height="79">																		
																...
																<tr>
																	<td colspan="2"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/header_m.gif" alt="" width="100" height="79" /></td>
																</tr>
																<tr>
																	<td style="background: url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_title.gif) no-repeat;" background="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_title.gif" valign="bottom" colspan="3" height="65" align="left">
																...
																<tr>
																	<td colspan="7" align="left" valign="top">
																		<table cellpadding="0" cellspacing="0" width="600" align="left">
																			<tr>
																				<td colspan="2"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/topbot_singlecol.gif" width="600" height="14" alt="" /></td>
																			</tr>
																			<tr>
																				<td valign="top" width="600">
																					...
																					<table cellpadding="0" cellspacing="0" width="600" class="whitecol">
																						<tr>
																							<td valign="top" width="15" rowspan="3"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/title_rightsinglecol_blue1.gif" alt="" width="15" height="56" /></td>
																							<td bgcolor="#eaf4f7" valign="top" width="21" rowspan="3"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/title_blue2.gif" alt="" width="21" height="56" /></td>
																							<td bgcolor="#eaf4f7"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" alt="" width="1" height="20" /></td>
																							<td bgcolor="#eaf4f7" rowspan="4"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" alt="" width="20" height="1" /></td>
																							<td rowspan="4"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" alt="" width="15" height="1" /></td>
																						</tr>
																						<tr>											
																			...
																			<tr>
																				<td colspan="2"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/topbot_singlecol.gif" width="600" height="10" alt="" />
															...
															<tr>
																<td colspan="3" style="background: url('. wp_ep_fitness_URLPATH.'admin/files/images/email-template/bg_bottom.png) no-repeat;"><img src="'. wp_ep_fitness_URLPATH.'admin/files/images/email-template/blank.gif" width="1" height="24" alt="" /></td>
															</tr>
...
';
update_option('ep_fitness_admin_email_textile', $admin_email_template3 ); 
update_option('ep_fitness_client_email_textile', $client_email_template3 );
...
update_option('ep_fitness_admin_email_newsletter_green', $admin_template_newsletter_green ); 
update_option('ep_fitness_client_email_newsletter_green', $client_template_newsletter_green );


$sucess_message='The mail has been sent successfully';
update_option('ep_fitness_success_message', $sucess_message );
$ep_fitness_fail_message='Not send. Please try again';
update_option('ep_fitness_fail_message', $ep_fitness_fail_message );

update_option('ep_fitness_auto_reply','yes' );

$form_content=trim('<link href="'.wp_ep_fitness_URLPATH.'admin/files/css/iv-bootstrap.css" rel="stylesheet" media="screen">
...
<div class="bootstrap-wrapper "><div class="container-fluid">
								<form id="ep_fitness_0" name="ep_fitness_0" class="form-horizontal" role="form" onsubmit="return false;">
									...
									<div class="row">
										...
										<div class="col-md-8">
											<button id="submit_ep_fitness_0" type="button" class="btn btn-success ctrl-btn btn-lg">Submit</button>					
										</div>
									</div></div>							
									</div>															
									<input type="hidden" name="hidden_form_name" id="hidden_form_name" value="ep_fitness_0">
								</form>					
							</div></div><script type="text/javascript">

		
		jQuery(document).ready(function(){
			jQuery("#submit_ep_fitness_0").on("click",function(){
						// validation
						...
						// end validation
						if(valid == 1){
							var ajaxurl = "'.wp_ep_fitness_ADMINPATH.'admin-ajax.php"
							var search_params={
								"action"  : "ep_fitness_submit",
								"form_data":	jQuery("#ep_fitness_0").serialize(), 
							};
							jQuery.ajax({					
								url : ajaxurl,								
								dataType : "json",
...
$ep_fitness_content_edit='	<form id="contact_form_iv" name="contact_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
									...
									<div class="row">
										...
										<label for="text" class="col-md-4 control-label"></label>
										<div class="col-md-8">
											<button id="submit_ep_fitness" type="button" class="btn btn-success ctrl-btn btn-lg">Submit</button>					
										</div>
									</div></div>							
									</div>															
									<input type="hidden" name="hidden_form_name" id="hidden_form_name" value="ep_fitness_0">
...
if($last_post_id==""){
	...
	$post_type = 'ep_fitness';
	$query = "UPDATE {$wpdb->prefix}posts SET post_type='".$post_type."' WHERE id='".$newpost_id."' LIMIT 1";
	$wpdb->query($query);		
	
	
	update_post_meta($newpost_id, 'ep_fitness_content', $ep_fitness_content_edit);
	update_post_meta($newpost_id, 'ep_fitness_auto_email', $client_email_template );
	update_post_meta($newpost_id, 'ep_fitness_admin_email', $admin_email_template );
	
	update_post_meta($newpost_id, 'ep_fitness_email_template_type', 'green' );
	update_post_meta($newpost_id, 'ep_fitness_width', 'col-md-12');
	
	$ep_fitness_admin_email_subject = get_bloginfo().': Contact Us';
	update_post_meta($newpost_id, 'ep_fitness_admin_email_subject', $ep_fitness_admin_email_subject);									
	update_post_meta($newpost_id, 'ep_fitness_auto_email_subject', $ep_fitness_admin_email_subject);
...
$form_content_newsletter='<link href="'.wp_ep_fitness_URLPATH.'admin/files/css/iv-bootstrap.css" rel="stylesheet" media="screen">
...
<div class="bootstrap-wrapper "><div class="container-fluid iv-custom-width">	
								...
								<form id="ep_fitness_1" name="ep_fitness_1" class="form-horizontal" role="form" onsubmit="return false;">
									...
									<div class="row">
										...
										<label for="text" class="col-md-4 control-label"></label>
										<div class="col-md-8">
											<button id="submit_ep_fitness_1" type="button" class="btn btn-success ctrl-btn">Subscribe Now</button>						
										</div>
									</div></div>							
									</div>															
									<input type="hidden" name="hidden_form_name" id="hidden_form_name" value="ep_fitness_1">
								</form>					
	...
	jQuery(document).ready(function(){
		jQuery("#submit_ep_fitness_1").on("click",function(){
						// validation
						var form_name = "#"+this.form.name
						var valid = 1;
						var succes_mess= "The mail has been sent successfully";
						var fail_mess= "Not send. Please try again";
						var loader_image = "<img  src=\''.wp_ep_fitness_URLPATH.'\admin/files/images/loader.gif\' />";
						...
						if(valid == 1){
							...
							var search_params={
								"action"  : "ep_fitness_submit",
								"form_data":	jQuery("#ep_fitness_1").serialize(), 
							};
...
$ep_fitness_content_edit_newsletter='				
								...
								<form id="contact_form_iv" name="contact_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
									...
									<div class="row">
										...
										<label for="text" class="col-md-4 control-label"></label>
										<div class="col-md-8">
											<button id="submit_ep_fitness" type="button" class="btn btn-success ctrl-btn" name=""> Subscribe Now</button>						
										</div>
									</div></div>							
									</div>															
									<input type="hidden" name="hidden_form_name" id="hidden_form_name" value="ep_fitness_1">
...
if($last_post_id==""){
	...
	update_post_meta($newpost_id, 'ep_fitness_content', $ep_fitness_content_edit_newsletter);
	update_post_meta($newpost_id, 'ep_fitness_auto_email', $client_email_template_newsletter );
	update_post_meta($newpost_id, 'ep_fitness_admin_email', $admin_email_template_newsletter );
	
	update_post_meta($newpost_id, 'ep_fitness_email_template_type', 'newsletter_green' );
	
	update_post_meta($newpost_id, 'ep_fitness_width', 'col-md-12');
	
	$ep_fitness_admin_email_subject = get_bloginfo().': Newsletter Subscription';
	update_post_meta($newpost_id, 'ep_fitness_admin_email_subject', $ep_fitness_admin_email_subject);									
	update_post_meta($newpost_id, 'ep_fitness_auto_email_subject',  $ep_fitness_admin_email_subject);
