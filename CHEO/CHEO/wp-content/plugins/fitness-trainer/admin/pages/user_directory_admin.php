	...
	<div class="welcome-panel container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-header" ><?php  _e('User Setting','epfitness')	;?>  <small>  </small> </h3>
        	 		 ...
        	 		 <form class=" dd col-md-6"   action="<?php echo the_permalink(); ?>" method="post"  >     
						...
						?>	
						 <table class="table">						 
						  <thead>
							<tr>	
							  <th> <?php  _e('Create Date','epfitness')	;?> </th>						 
							  <th> <?php  _e('User Name','epfitness')	;?></th>
							  <th> <?php  _e('Email','epfitness')	;?> </th>
							  <th> <?php  _e('Expiry Date','epfitness')	;?> </th>
							  <th> <?php  _e('Payment Status','epfitness')	;?> </th>							  
							  <th> <?php  _e('Role','epfitness')	;?> </th>
							  <th> <?php  _e('Content','epfitness')	;?> </th>
				        	...
				        	foreach ( $user_query->results as $user ) {								
								...
								?>
									<tr>
									  ...
									  <td>		<a class="btn btn-primary btn-xs" href="?page=wp-ep_fitness-user_update&id=<?php echo $user->ID; ?>"> <?php  _e('Edit','epfitness')	;?></a> 
												<a class="btn btn-danger btn-xs" href="<?php echo admin_url().'/users.php'?>"><?php  _e('Delete','epfitness')	;?> </a>
									  </td>
									</tr>
