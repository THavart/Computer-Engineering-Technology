<div class="form-group">
		...
		<div class="col-md-4 ">
			...
			<?php
			 $refund_message_link='';
			 if( get_option( '_ep_fitness_refund_message_link' ) ) {
				  $refund_message_link= get_option('_ep_fitness_refund_message_link'); 
			 }	 
			 //echo  $t_terms;
			?><label>
...
<div class="form-group">
		...
		<div class="col-md-4 ">
				...
				<?php
				$ep_fitness_refund_email_subject = get_option( 'ep_fitness_refund_email_subject');
				?>
				
				<input type="text" class="form-control" id="refund_email_subject" name="refund_email_subject" value="<?php echo $ep_fitness_refund_email_subject; ?>" placeholder="Enter subject">
...
<div class="form-group">
		...
		<div class="col-md-10 ">
					...
					$content_client = get_option( 'ep_fitness_refund_email');
					$editor_id = 'ep_fitness_refund_email';
