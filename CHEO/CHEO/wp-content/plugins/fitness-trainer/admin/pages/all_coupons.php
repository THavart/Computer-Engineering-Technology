			...
			<div class="row ">					
				<div class="col-md-12" id="submit-button-holder">					
					<div class="pull-right ">								
						...
						<a class="btn btn-info "  href="<?php echo wp_ep_fitness_ADMINPATH; ?>admin.php?page=wp-ep_fitness-coupon-create">Create A New Coupon</a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-12 table-responsive">
					...
					<table class="table table-striped col-md-12">
						...
						<tbody>
							<?php
							global $wpdb, $post;
							$sql="SELECT * FROM $wpdb->posts WHERE post_type = 'iv_coupon'";
							...
							if(sizeof($products_rows)>0){
								...
								{	
									...
									echo '<td>'. get_post_meta($row->ID, 'iv_coupon_amount', true).'</td>';
										...
										echo '  <a href="?page=wp-ep_fitness-coupons-form&delete_id='.$row->ID.'" class="btn btn-danger btn-xs" onclick="return confirm(\'Are you sure to delete this form?\');">Delete</a></td>';
