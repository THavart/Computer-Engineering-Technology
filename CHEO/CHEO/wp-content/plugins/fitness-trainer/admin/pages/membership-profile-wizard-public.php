		...
		<div class="form-group col-md-12 row">
			...
			<div class="row ">
				...
				<div class="col-md-10" >
					...
					-->
					<?php 
					$form_wizard=get_option('_ep_fitness_profile_public_page');
			...
			<table class="table table-striped">
				<?php
					$opt_style=	get_option('ep_fitness_profile-public');
				?>
				<tr>
					<td width ="15%">
							<label >
					...
					<td>
						<?php include( wp_ep_fitness_template. 'profile-public/profile-template-1.php');?>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						<?php include( wp_ep_fitness_template. 'profile-public/profile-template-2.php');?>
					</td>	
				</tr>
			</table>	
...
function update_profile_public_template(){
		...
		var search_params = {
			"action": 			"ep_fitness_update_profile_public_template",
