					  ...
					  <tbody>
						<tr>
						  ...
						  <td><?php echo (get_option('ep_fitness_payment_gateway')=='paypal-express')? 'Active':'Inactive' ?> </td>
						   <td><a class="btn btn-primary btn-xs" href="?page=wp-ep_fitness-payment-paypal"> Edit Setting</a></td>
						</tr>
						<tr>
						  <td>2</td>
						  <td>
						  ...
						  <td> <a class="btn btn-primary btn-xs" href="?page=wp-ep_fitness-payment-stripe"> Edit Setting</a> </td>
						</tr>
						<!--
						<tr>
						  <td>2</td>
						  <td><input name='payment_gateway' id='payment_gateway'  type="radio" <?php echo (get_option('ep_fitness_payment_gateway')=='authorize')? 'checked':'' ?>  value="authorize.net">
									Authorize.net
						  </label> </td>
						  <td>Test</td>
						  <td><?php echo (get_option('ep_fitness_payment_gateway')=='authorize')? 'Active':'Inactive' ?></td>
						  <td> <a class="btn btn-primary btn-xs" href="?page=wp-ep_fitness-payment-authorize"> Edit</a> </td>
						</tr>
						-->
					  </tbody>
					</table>
