<?php	
echo '<link href="' . wp_ep_fitness_URLPATH . 'admin/files/css/jquery-ui.css" rel="stylesheet" media="screen">
	...
	function iv_create_coupon() {
				...
				jQuery.ajax({					
					...
					success : function(response){
						var url = "<?php echo wp_ep_fitness_ADMINPATH; ?>admin.php?page=wp-ep_fitness-coupons-form&form_submit=success";    						
