							...
							<div class="form-group">
							 ...
							 <div class="form-group">
							  ...
							  <div class="form-group">
								...
								<div class="col-md-5">
								  <input type="text" class="form-control" name="paypal_username" id="paypal_username" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_paypal_username', true); ?>" placeholder="Enter Paypal Username">
								</div>
							  </div>
							  ...
							  <div class="form-group">
								...
								<div class="col-md-5">
								  <input type="text" class="form-control" id="paypal_api_password" name="paypal_api_password" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_paypal_api_password', true); ?>"  placeholder="Enter Paypal Api Password">
								</div>
							  </div>
								...
								<div class="col-md-5">
								  <input type="text" class="form-control" id="paypal_api_signature" name="paypal_api_signature" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_paypal_api_signature', true); ?>"  placeholder="Enter Paypal Api Signature">
								</div>
							  </div>
							  <div class="form-group">
								...
								<div class="col-md-5">
									...
									<!--
								  <input type="text" class="form-control" id="paypal_api_currency" name="paypal_api_currency" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_paypal_api_currency', true); ?>"  placeholder="Enter Paypal Api Currency">
								  -->
								</div>
							  </div>
