	...
	function update_stripe_setting() {
				...
				jQuery.ajax({					
					...
					success : function(response){
						jQuery('#iv-loading').html('<div class="col-md-12 alert alert-success">Update Successfully. <a class="btn btn-success btn-xs" href="?page=wp-ep_fitness-payment-settings"> Go Payment Setting Page</aa></div>');
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
							  ...
							  <div class="form-group">
								...
								<div class="col-md-8">
								  <input type="text" class="form-control" name="secret_key" id="secret_key" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_stripe_live_secret_key', true); ?>" placeholder="Enter stripe secret key">
								</div>
							  </div>
							  ...
							  <div class="form-group">
								...
								<div class="col-md-8">
								  <input type="text" class="form-control" id="publishable_key" name="publishable_key" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_stripe_live_publishable_key', true); ?>"  placeholder="Enter stripe Api publishable key">
								</div>
							  </div>
								<div class="col-md-12">
									<hr>
								...
								<div class="col-md-8">
								  <input type="text" class="form-control" id="secret_key_test" name="secret_key_test" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_stripe_secret_test', true); ?>"  placeholder="Enter stripe Api Secret Key">
								</div>
							  </div>
							   <div class="form-group">
								<label for="inputEmail3" class="col-md-4 control-label">Test Publishable</label>
								<div class="col-md-8">
								  <input type="text" class="form-control" id="stripe_publishable_test" name="stripe_publishable_test" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_stripe_publishable_test', true); ?>"  placeholder="Enter stripe Api publishable Key">
								</div>
							  </div>
							  ...
							  <div class="form-group">
								...
								<div class="col-md-8">
									...
									<!--
								  <input type="text" class="form-control" id="stripe_api_currency" name="stripe_api_currency" value="<?php echo get_post_meta($newpost_id, 'ep_fitness_stripe_api_currency', true); ?>"  placeholder="Enter stripe Api Currency">
								  -->
								</div>
							  </div>
