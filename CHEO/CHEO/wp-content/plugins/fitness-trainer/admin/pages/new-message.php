...
<div class="form-group">
		...
		<div class="col-md-4 ">
				...
				<input type="text" class="form-control" id="contact_email_subject" name="contact_email_subject" value="<?php echo $ep_fitness_contact_email_subject; ?>" placeholder="Enter subject">
