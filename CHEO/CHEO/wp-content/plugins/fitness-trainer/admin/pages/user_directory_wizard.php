	...
	<div class="welcome-panel container-fluid">
		...
		<div class="form-group col-md-12 row">
			...
			<div class="row ">
				...
				<div class="col-md-4" >
					[ep_fitness_user_directory per_page="12"]
				</div>
			...
			<div class="row ">
				...
				<div class="col-md-10" >
							<p>
										&lt;?php
										echo do_shortcode('[ep_fitness_user_directory per_page="12"]');
										?&gt;</p>	
				</div>
			</div>
			<div class="row ">
				...
				<div class="col-md-10" >
					...
					-->
					<?php 
					$form_wizard=get_option('_ep_fitness_user_dir_page');
			...
			<table class="table table-striped">
				<?php
					...
					if (!file_exists($filename)) { 										
						...
						if (!file_exists($folder_check_theme)) {
							...
							define( 'wp_ep_fitness_user_dir', $filename);
						}	
				...
				<tr>
					...
					<td>
						<?php include( wp_ep_fitness_user_dir. 'user-directory/directory-template-1.php');?>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
					<?php include( wp_ep_fitness_user_dir. 'user-directory/directory-template-2.php');?>
					</td>	
				</tr>
...
function update_user_directory_template(){
		...
		var search_params = {
			"action": 			"ep_fitness_update_user_directory",
