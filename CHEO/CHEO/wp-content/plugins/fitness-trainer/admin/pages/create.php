		...
		<!--
		.bg-image_drag{
			background-image: url(<?php echo wp_ep_fitness_URLPATH; ?>admin/files/images/DragDropFile.png);
			background-position:center center;
		}
		-->
		.custom_style{
			background:url("<?php echo wp_ep_fitness_URLPATH; ?>admin/files/images/images1.jpg") center 60% no-repeat;
			text-align:center;
		}
		...
		jQuery(document).ready(function(){
			jQuery("#submit_ep_fitness").on("click",function(){
						// validation
						var form_name = "#"+this.form.name
						var valid = 1;
						var succes_mess= "<?php echo get_option('ep_fitness_success_message'); ?>";
						var fail_mess= "<?php echo get_option('ep_fitness_fail_message'); ?>";
						...
						if(valid == 1){
							...
							jQuery('#loading').html("<img src='<?php echo wp_ep_fitness_URLPATH. 'admin/files/images/loader.gif'; ?>' />");
	...
	function save_the_form() {
		...
		var dialogContent  ='';
		dialogContent+= '<link href="<?php echo wp_ep_fitness_URLPATH; ?>admin/files/css/iv-bootstrap.css" rel="stylesheet" media="screen">\n';



		dialogContent+='<style>\n'+jQuery("#content-styles").html()+'\n</style>\n';
		var ep_fitness_width_type = jQuery('input:radio[name=ep_fitness_width]:checked').val();
		var ep_fitness_width=ep_fitness_width_type;	
						
		var ep_fitness_width_css="";
			if(ep_fitness_width_type=='custom_width'){
				var ep_fitness_width_input = jQuery('#ep_fitness_width-input').val();
				var ep_fitness_width=ep_fitness_width_input;	
				
				ep_fitness_width_css ='<style>\n .iv-custom-width{ width:'+ep_fitness_width_input+' !important;} \n</style>\n';
				dialogContent=dialogContent + ep_fitness_width_css;
			}
		...
		var ep_fitness_auto_email=jQuery("#client_email_template").val();
		var ep_fitness_admin_email=jQuery("#admin_email_template").val();
		var iv_client_email =		jQuery("#client-email").val(); 
				// New Block For Ajax*****
				var search_params={
					"action"  : 				"ep_fitness_save_form",	
					...
					"ep_fitness_auto_email" :	ep_fitness_auto_email,	
					"ep_fitness_admin_email" :	ep_fitness_admin_email,
					"client-email" 	:		iv_client_email,	
					"ep_fitness_width" 	:	ep_fitness_width,	
					"ep_fitness_email_template_type" 	:jQuery("#all-tempalte").val(),	
					"ep_fitness_auto_email_subject" 	:	jQuery("[name=ep_fitness_auto_email_subject]").val(),	
					"ep_fitness_admin_email_subject" 	:	jQuery("[name=ep_fitness_admin_email_subject]").val(),	
				...
				jQuery.ajax({					
					...
					success : function(response){
						...
						var url = "<?php echo wp_ep_fitness_ADMINPATH; ?>admin.php?page=wp-ep_fitness-from-all&form_submit=success";    						
			...
			<script>
				jQuery(function(){				 
				  ...
				  var  ep_fitness_width = jQuery("#ep_fitness_width-input");
				  var iv_responsive =jQuery("#Responsive"); 

					  radioButton.change(function () { 
						if( this.checked ) { 
						  ep_fitness_width.show();
						}
					  });
					iv_responsive.click(function (){
					 ep_fitness_width.hide(); 
					});
				});
			...
			jQuery(function(){	
						...
						var valueSelected = this.value;
							...
							var tempalte_params={
								"action"  : 				"ep_fitness_email_admin_template_change",										
								"ep_fitness_template" 	:		valueSelected,	
							};
							jQuery.ajax({					
								url : ajaxurl,					 
								//dataType : "json",
							...
							var tempalte_params={
								"action"  : 				"ep_fitness_email_client_template_change",										
								"ep_fitness_template" 	:		valueSelected,	
							};
							jQuery.ajax({					
								url : ajaxurl,					 
				...
				<div class="welcome-panel container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							<div id="listOfFields" class="col-md-5 well tab-content">
								<div class="tab-pane active form-group" id="simple">
									...
									<div class="form-group selectorField draggableField row" style="z-index:12;">									
										...
										<div class="col-md-8">
											<button  id="submit_ep_fitness" type="button" class="btn btn-default ctrl-btn ">Send Now</button>										
										</div>
									</div>
									<div class="form-group selectorField draggableField row" style="z-index:12;">									
										<label for="text" class="col-md-4 control-label"></label>
										<div class="col-md-8">
											<button id="submit_ep_fitness" type="button" class="btn btn-primary ctrl-btn">Submit</button>							
										</div>
									</div>
									<div class="form-group selectorField draggableField row" style="z-index:12;">									
										<label for="text" class="col-md-4 control-label"></label>
										<div class="col-md-8">
											<button  id="submit_ep_fitness" type="button" class="btn btn-success ctrl-btn"  > Send Now</button>						
										</div>
									</div>
									<div class="form-group selectorField draggableField row" style="z-index:12;">									
										<label for="text" class="col-md-4 control-label"></label>
									...
									<div class="form-group selectorField draggableField row" style="z-index:12;">									
										<label for="text" class="col-md-4 control-label"></label>
										<div class="col-md-8">
											<button id="submit_ep_fitness" type="button" class="btn btn-default ctrl-btn btn-lg"  >Submit</button>					
										</div>
									</div>	
									<div class="form-group selectorField draggableField row" style="z-index:12;">									
							...
							<div class="col-md-1 arrow_right">
								<img  class="col-md-12" src="<?php echo wp_ep_fitness_URLPATH; ?>admin/files/images/icon-arrow-right.png"> 
							</div>
														...
														<label for="text" class="col-md-4 control-label">Form Width</label>
															...
															<div class="col-md-8">
																<div class=" ctrl-radiogroup">
																	<label class="radio"><input type="radio" name="ep_fitness_width" value="Responsive" id="Responsive" checked />Responsive</label>
																	<label class="radio"><input type="radio" name="ep_fitness_width"  id ="fixed_width" value="custom_width" /> Fixed Width
																	<input type="text"  id="ep_fitness_width-input" name="ep_fitness_width-input" class="form-control"  value="" placeholder="Enter Form Width  Like 500px" style="display: none" >	</label>
						...
						<div class="row">
							<div class="col-md-5">
								...
								<div class="col-md-8">
									...
									?>
									<input type="text" class="form-control" id="ep_fitness_admin_email_subject" name="ep_fitness_admin_email_subject" value="<?php echo $ep_fitness_admin_email_subject; ?>" placeholder="Enter admin email subjec">
								</div>
							</div>	
							<div class="col-md-1">
							...
							<div class="col-md-6">
								...
								<div class="col-md-8">
									<?php
									$ep_fitness_auto_email_subject = get_bloginfo().': Contact Us';
									?>
									<input type="text" class="form-control" id="ep_fitness_auto_email_subject" name="ep_fitness_auto_email_subject" value="<?php echo $ep_fitness_auto_email_subject; ?>" placeholder="Enter auto email subject">
								</div>
							</div>	
						</div>			
						<div class="row"><br />
					...
					<div class="row">
						<div class="col-md-5">
							...
							<a data-toggle="modal" href="<?php echo wp_ep_fitness_URLPATH; ?>admin/pages/template_email_modal.php?upath=<?php echo wp_ep_fitness_URLPATH; ?>" data-target="#modal_template_help"><img  title="Template Preview" class=" right top"  height="30px" src="<?php echo wp_ep_fitness_URLPATH; ?>admin/files/images/eye-open-128.png"></a></small></h3> 
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="email-wrap" id="admin-template">
								...
								$content_admin = get_option('ep_fitness_admin_email_green');
						...
						<div class="col-md-6 ">
							...
							<div class="col-md-12 email-wrap" id="client-template">
								...
								$content_client = get_option('ep_fitness_client_email_green');
