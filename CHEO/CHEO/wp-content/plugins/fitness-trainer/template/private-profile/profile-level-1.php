...
?>
 ...
 $current_user = wp_get_current_user();
		...
		$payment_gateway=get_user_meta($userId, 'ep_fitness_payment_gateway', true);
		if($payment_gateway=='paypal-express'){
				...
				if($payment_status=='pending'){
					...
					//echo ' <br/>Time........'. strtotime (get_user_meta('29', 'ep_fitness_exprie_date', true)).'...$exprie_date...'.$exprie_date;
					   ...
					   <?php
						  ...
						  <div class="table-responsive">
							...
							<tr>
									...
									<td width="60%" style="font-size:14px">
									<?php
										echo get_user_meta($current_user->ID, 'ep_fitness_payment_status', true);
										?>
									</td>
							</tr>
							<tr>
