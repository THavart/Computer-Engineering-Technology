...
// For Template ****
update_option('ep_fitness_reminder_email', $reminder_email_template  ); 

// For Subject ****

$reminder_subject = get_bloginfo().': Subscription Reminder ';
update_option('ep_fitness_reminder_email_subject', $reminder_subject ); 
update_option('ep_fitness_reminder_day', '10'); 
...
/*		
	...
	$page_content='[ep_fitness_reminder_email_cron]';
	$my_post_form = array(
	...
	update_option('_ep_fitness_remainder_email_page', $newpost_id);
