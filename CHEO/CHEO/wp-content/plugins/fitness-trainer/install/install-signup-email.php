...
update_option('ep_fitness_signup_email', trim($client_signup_email_template)  ); 


$signup_subject = 'Welcome To '.get_bloginfo();

update_option('ep_fitness_signup_email_subject', $signup_subject  ); 
...
update_option('ep_fitness_forget_email', trim($client_forget_email_template)  ); 
$forget_subject = 'Forget Password '.get_bloginfo();
update_option('ep_fitness_forget_email_subject', $forget_subject  ); 
...
update_option('ep_fitness_contact_email', trim($contact_email_template)  ); 
$contact_subject = 'New Message '.get_bloginfo();
update_option('ep_fitness_contact_email_subject', $contact_subject  ); 
...
update_option('ep_fitness_refund_email', trim($money_refund_email_template)  ); 
$money_refund_email_subject = 'Money Refund Request '.get_bloginfo();
update_option('ep_fitness_refund_email_subject', $money_refund_email_subject  ); 
...
update_option('ep_fitness_deal_email', trim($deal_email_template)  ); 
$deal_email_subject = 'Coupon Order '.get_bloginfo();
update_option('ep_fitness_deal_email_subject', $deal_email_subject  ); 
