...
/**
 * Servlet implementation class ServletActive
 */
@WebServlet("/Active")
public class ServletActive extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletActive() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession().setAttribute("ViewEdit", "Active Tickets");
